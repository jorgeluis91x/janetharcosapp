...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { date: @movement.date, invoice_id: @movement.invoice_id, movement_type_id: @movement.movement_type_id, observation: @movement.observation, sum: @movement.sum }
    end
  ...
  test "should update movement" do
    patch :update, id: @movement, movement: { date: @movement.date, invoice_id: @movement.invoice_id, movement_type_id: @movement.movement_type_id, observation: @movement.observation, sum: @movement.sum }
    assert_redirected_to movement_path(assigns(:movement))
  end
